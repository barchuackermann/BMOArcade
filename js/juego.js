...
var instrucciones = ["Usá las flechas del teclado", "Mové las piezas para armar el rompecabezas"];
...
function chequearSiGano(grilla1, grilla2){ 
  for (var i = 0; i < grilla1.length ; i++) {
      for (var j = 0; j < grilla1[i].length; j++) {
        console.log(grilla1[i][j]);
        console.log(grilla2[i][j]);
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    var nuevaPos1 = grilla[filaPos1][columnaPos1];
    var nuevaPos2 = grilla[filaPos2][columnaPos2];

    grilla[filaPos1][columnaPos1]=nuevaPos2;
    grilla[filaPos2][columnaPos2]=nuevaPos1;
}
...
function mostrarInstruccionEnLista(instruccion, listainstrucciones) {
  var ul = document.getElementById(listainstrucciones);
...
var gano = chequearSiGano(grilla,grillaOk);
        if (gano) {
          setTimeout(function() {
